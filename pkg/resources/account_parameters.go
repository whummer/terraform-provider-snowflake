...
func handleAccountParametersCreate(d *schema.ResourceData, parameters *sdk.AccountParameters) diag.Diagnostics {
	diags := JoinDiags(
		...
		handleParameterCreate(d, sdk.AccountParameterSamlIdentityProvider, &parameters.SamlIdentityProvider),
...
func handleAccountParametersUpdate(d *schema.ResourceData, set *sdk.AccountParameters, unset *sdk.AccountParametersUnset) diag.Diagnostics {
	diags := JoinDiags(
		...
		handleParameterUpdate(d, sdk.AccountParameterSamlIdentityProvider, &set.SamlIdentityProvider, &unset.SamlIdentityProvider),
