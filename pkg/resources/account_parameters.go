...
func handleAccountParametersCreate(d *schema.ResourceData, set *sdk.AccountSet) diag.Diagnostics {
	set.Parameters = new(sdk.AccountParameters)

	diags := JoinDiags(
		// Bool parameters
		handleParameterCreate(d, sdk.AccountParameterAbortDetachedQuery, &set.Parameters.AbortDetachedQuery),
		handleParameterCreate(d, sdk.AccountParameterAllowClientMFACaching, &set.Parameters.AllowClientMFACaching),
		handleParameterCreate(d, sdk.AccountParameterAllowIDToken, &set.Parameters.AllowIDToken),
		handleParameterCreate(d, sdk.AccountParameterAutocommit, &set.Parameters.Autocommit),
		handleParameterCreate(d, sdk.AccountParameterClientEnableLogInfoStatementParameters, &set.Parameters.ClientEnableLogInfoStatementParameters),
		handleParameterCreate(d, sdk.AccountParameterClientMetadataRequestUseConnectionCtx, &set.Parameters.ClientMetadataRequestUseConnectionCtx),
		handleParameterCreate(d, sdk.AccountParameterClientMetadataUseSessionDatabase, &set.Parameters.ClientMetadataUseSessionDatabase),
		handleParameterCreate(d, sdk.AccountParameterClientResultColumnCaseInsensitive, &set.Parameters.ClientResultColumnCaseInsensitive),
		handleParameterCreate(d, sdk.AccountParameterClientSessionKeepAlive, &set.Parameters.ClientSessionKeepAlive),
		handleParameterCreate(d, sdk.AccountParameterDisableUiDownloadButton, &set.Parameters.DisableUiDownloadButton),
		handleParameterCreate(d, sdk.AccountParameterDisableUserPrivilegeGrants, &set.Parameters.DisableUserPrivilegeGrants),
		handleParameterCreate(d, sdk.AccountParameterEnableAutomaticSensitiveDataClassificationLog, &set.Parameters.EnableAutomaticSensitiveDataClassificationLog),
		handleParameterCreate(d, sdk.AccountParameterEnableEgressCostOptimizer, &set.Parameters.EnableEgressCostOptimizer),
		handleParameterCreate(d, sdk.AccountParameterEnableIdentifierFirstLogin, &set.Parameters.EnableIdentifierFirstLogin),
		handleParameterCreate(d, sdk.AccountParameterEnableInternalStagesPrivatelink, &set.Parameters.EnableInternalStagesPrivatelink),
		handleParameterCreate(d, sdk.AccountParameterEnableTriSecretAndRekeyOptOutForImageRepository, &set.Parameters.EnableTriSecretAndRekeyOptOutForImageRepository),
		handleParameterCreate(d, sdk.AccountParameterEnableTriSecretAndRekeyOptOutForSpcsBlockStorage, &set.Parameters.EnableTriSecretAndRekeyOptOutForSpcsBlockStorage),
		handleParameterCreate(d, sdk.AccountParameterEnableUnhandledExceptionsReporting, &set.Parameters.EnableUnhandledExceptionsReporting),
		handleParameterCreate(d, sdk.AccountParameterEnableUnloadPhysicalTypeOptimization, &set.Parameters.EnableUnloadPhysicalTypeOptimization),
		handleParameterCreate(d, sdk.AccountParameterEnableUnredactedQuerySyntaxError, &set.Parameters.EnableUnredactedQuerySyntaxError),
		handleParameterCreate(d, sdk.AccountParameterEnableUnredactedSecureObjectError, &set.Parameters.EnableUnredactedSecureObjectError),
		handleParameterCreate(d, sdk.AccountParameterEnforceNetworkRulesForInternalStages, &set.Parameters.EnforceNetworkRulesForInternalStages),
		handleParameterCreate(d, sdk.AccountParameterErrorOnNondeterministicMerge, &set.Parameters.ErrorOnNondeterministicMerge),
		handleParameterCreate(d, sdk.AccountParameterErrorOnNondeterministicUpdate, &set.Parameters.ErrorOnNondeterministicUpdate),
		handleParameterCreate(d, sdk.AccountParameterExternalOAuthAddPrivilegedRolesToBlockedList, &set.Parameters.ExternalOAuthAddPrivilegedRolesToBlockedList),
		handleParameterCreate(d, sdk.AccountParameterJdbcTreatDecimalAsInt, &set.Parameters.JdbcTreatDecimalAsInt),
		handleParameterCreate(d, sdk.AccountParameterJdbcTreatTimestampNtzAsUtc, &set.Parameters.JdbcTreatTimestampNtzAsUtc),
		handleParameterCreate(d, sdk.AccountParameterJdbcUseSessionTimezone, &set.Parameters.JdbcUseSessionTimezone),
		handleParameterCreate(d, sdk.AccountParameterJsTreatIntegerAsBigInt, &set.Parameters.JsTreatIntegerAsBigInt),
		handleParameterCreate(d, sdk.AccountParameterNoorderSequenceAsDefault, &set.Parameters.NoorderSequenceAsDefault),
		handleParameterCreate(d, sdk.AccountParameterOAuthAddPrivilegedRolesToBlockedList, &set.Parameters.OAuthAddPrivilegedRolesToBlockedList),
		handleParameterCreate(d, sdk.AccountParameterOdbcTreatDecimalAsInt, &set.Parameters.OdbcTreatDecimalAsInt),
		handleParameterCreate(d, sdk.AccountParameterPeriodicDataRekeying, &set.Parameters.PeriodicDataRekeying),
		handleParameterCreate(d, sdk.AccountParameterPipeExecutionPaused, &set.Parameters.PipeExecutionPaused),
		handleParameterCreate(d, sdk.AccountParameterPreventUnloadToInlineURL, &set.Parameters.PreventUnloadToInlineURL),
		handleParameterCreate(d, sdk.AccountParameterPreventUnloadToInternalStages, &set.Parameters.PreventUnloadToInternalStages),
		handleParameterCreate(d, sdk.AccountParameterQuotedIdentifiersIgnoreCase, &set.Parameters.QuotedIdentifiersIgnoreCase),
		handleParameterCreate(d, sdk.AccountParameterReplaceInvalidCharacters, &set.Parameters.ReplaceInvalidCharacters),
		handleParameterCreate(d, sdk.AccountParameterRequireStorageIntegrationForStageCreation, &set.Parameters.RequireStorageIntegrationForStageCreation),
		handleParameterCreate(d, sdk.AccountParameterRequireStorageIntegrationForStageOperation, &set.Parameters.RequireStorageIntegrationForStageOperation),
		handleParameterCreate(d, sdk.AccountParameterSsoLoginPage, &set.Parameters.SsoLoginPage),
		handleParameterCreate(d, sdk.AccountParameterStrictJsonOutput, &set.Parameters.StrictJsonOutput),
		handleParameterCreate(d, sdk.AccountParameterTimestampDayIsAlways24h, &set.Parameters.TimestampDayIsAlways24h),
		handleParameterCreate(d, sdk.AccountParameterTransactionAbortOnError, &set.Parameters.TransactionAbortOnError),
		handleParameterCreate(d, sdk.AccountParameterUseCachedResult, &set.Parameters.UseCachedResult),

		// Int parameters
		handleParameterCreate(d, sdk.AccountParameterClientEncryptionKeySize, &set.Parameters.ClientEncryptionKeySize),
		handleParameterCreate(d, sdk.AccountParameterClientMemoryLimit, &set.Parameters.ClientMemoryLimit),
		handleParameterCreate(d, sdk.AccountParameterClientPrefetchThreads, &set.Parameters.ClientPrefetchThreads),
		handleParameterCreate(d, sdk.AccountParameterClientResultChunkSize, &set.Parameters.ClientResultChunkSize),
		handleParameterCreate(d, sdk.AccountParameterClientSessionKeepAliveHeartbeatFrequency, &set.Parameters.ClientSessionKeepAliveHeartbeatFrequency),
		handleParameterCreate(d, sdk.AccountParameterDataRetentionTimeInDays, &set.Parameters.DataRetentionTimeInDays),
		handleParameterCreate(d, sdk.AccountParameterHybridTableLockTimeout, &set.Parameters.HybridTableLockTimeout),
		handleParameterCreate(d, sdk.AccountParameterJsonIndent, &set.Parameters.JsonIndent),
		handleParameterCreate(d, sdk.AccountParameterLockTimeout, &set.Parameters.LockTimeout),
		handleParameterCreate(d, sdk.AccountParameterMaxConcurrencyLevel, &set.Parameters.MaxConcurrencyLevel),
		handleParameterCreate(d, sdk.AccountParameterMaxDataExtensionTimeInDays, &set.Parameters.MaxDataExtensionTimeInDays),
		handleParameterCreate(d, sdk.AccountParameterMinDataRetentionTimeInDays, &set.Parameters.MinDataRetentionTimeInDays),
		handleParameterCreate(d, sdk.AccountParameterMultiStatementCount, &set.Parameters.MultiStatementCount),
		handleParameterCreate(d, sdk.AccountParameterRowsPerResultset, &set.Parameters.RowsPerResultset),
		handleParameterCreate(d, sdk.AccountParameterStatementTimeoutInSeconds, &set.Parameters.StatementTimeoutInSeconds),
		handleParameterCreate(d, sdk.AccountParameterStatementQueuedTimeoutInSeconds, &set.Parameters.StatementQueuedTimeoutInSeconds),
		handleParameterCreate(d, sdk.AccountParameterSuspendTaskAfterNumFailures, &set.Parameters.SuspendTaskAfterNumFailures),
		handleParameterCreate(d, sdk.AccountParameterTaskAutoRetryAttempts, &set.Parameters.TaskAutoRetryAttempts),
		handleParameterCreate(d, sdk.AccountParameterTwoDigitCenturyStart, &set.Parameters.TwoDigitCenturyStart),
		handleParameterCreate(d, sdk.AccountParameterUserTaskMinimumTriggerIntervalInSeconds, &set.Parameters.UserTaskMinimumTriggerIntervalInSeconds),
		handleParameterCreate(d, sdk.AccountParameterUserTaskTimeoutMs, &set.Parameters.UserTaskTimeoutMs),
		handleParameterCreate(d, sdk.AccountParameterWeekOfYearPolicy, &set.Parameters.WeekOfYearPolicy),
		handleParameterCreate(d, sdk.AccountParameterWeekStart, &set.Parameters.WeekStart),

		// String parameters
		handleParameterCreateWithMapping(d, sdk.AccountParameterActivePythonProfiler, &set.Parameters.ActivePythonProfiler, sdk.ToActivePythonProfiler),
		handleParameterCreate(d, sdk.AccountParameterBaseLocationPrefix, &set.Parameters.BaseLocationPrefix),
		handleParameterCreateWithMapping(d, sdk.AccountParameterBinaryInputFormat, &set.Parameters.BinaryInputFormat, sdk.ToBinaryInputFormat),
		handleParameterCreateWithMapping(d, sdk.AccountParameterBinaryOutputFormat, &set.Parameters.BinaryOutputFormat, sdk.ToBinaryOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterCatalog, &set.Parameters.Catalog),
		handleParameterCreate(d, sdk.AccountParameterCatalogSync, &set.Parameters.CatalogSync),
		handleParameterCreateWithMapping(d, sdk.AccountParameterClientTimestampTypeMapping, &set.Parameters.ClientTimestampTypeMapping, sdk.ToClientTimestampTypeMapping),
		handleParameterCreate(d, sdk.AccountParameterCortexEnabledCrossRegion, &set.Parameters.CortexEnabledCrossRegion),
		handleParameterCreate(d, sdk.AccountParameterCortexModelsAllowlist, &set.Parameters.CortexModelsAllowlist),
		handleParameterCreate(d, sdk.AccountParameterCsvTimestampFormat, &set.Parameters.CsvTimestampFormat),
		handleParameterCreate(d, sdk.AccountParameterDateInputFormat, &set.Parameters.DateInputFormat),
		handleParameterCreate(d, sdk.AccountParameterDateOutputFormat, &set.Parameters.DateOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterDefaultDDLCollation, &set.Parameters.DefaultDDLCollation),
		handleParameterCreate(d, sdk.AccountParameterDefaultNotebookComputePoolCpu, &set.Parameters.DefaultNotebookComputePoolCpu),
		handleParameterCreate(d, sdk.AccountParameterDefaultNotebookComputePoolGpu, &set.Parameters.DefaultNotebookComputePoolGpu),
		handleParameterCreateWithMapping(d, sdk.AccountParameterDefaultNullOrdering, &set.Parameters.DefaultNullOrdering, sdk.ToDefaultNullOrdering),
		handleParameterCreateWithMapping(d, sdk.AccountParameterDefaultStreamlitNotebookWarehouse, &set.Parameters.DefaultStreamlitNotebookWarehouse, sdk.ParseAccountObjectIdentifier),
		handleParameterCreateWithMapping(d, sdk.AccountParameterEventTable, &set.Parameters.EventTable, sdk.ParseSchemaObjectIdentifier),
		handleParameterCreateWithMapping(d, sdk.AccountParameterExternalVolume, &set.Parameters.ExternalVolume, sdk.ParseAccountObjectIdentifier),
		handleParameterCreateWithMapping(d, sdk.AccountParameterGeographyOutputFormat, &set.Parameters.GeographyOutputFormat, sdk.ToGeographyOutputFormat),
		handleParameterCreateWithMapping(d, sdk.AccountParameterGeometryOutputFormat, &set.Parameters.GeometryOutputFormat, sdk.ToGeometryOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterInitialReplicationSizeLimitInTB, &set.Parameters.InitialReplicationSizeLimitInTB),
		handleParameterCreate(d, sdk.AccountParameterListingAutoFulfillmentReplicationRefreshSchedule, &set.Parameters.ListingAutoFulfillmentReplicationRefreshSchedule),
		handleParameterCreateWithMapping(d, sdk.AccountParameterLogLevel, &set.Parameters.LogLevel, sdk.ToLogLevel),
		handleParameterCreateWithMapping(d, sdk.AccountParameterMetricLevel, &set.Parameters.MetricLevel, sdk.ToMetricLevel),
		handleParameterCreateWithMapping(d, sdk.AccountParameterNetworkPolicy, &set.Parameters.NetworkPolicy, sdk.ParseAccountObjectIdentifier),
		handleParameterCreate(d, sdk.AccountParameterPythonProfilerModules, &set.Parameters.PythonProfilerModules),
		handleParameterCreateWithMapping(d, sdk.AccountParameterPythonProfilerTargetStage, &set.Parameters.PythonProfilerTargetStage, sdk.ParseSchemaObjectIdentifier),
		handleParameterCreate(d, sdk.AccountParameterQueryTag, &set.Parameters.QueryTag),
		handleParameterCreate(d, sdk.AccountParameterS3StageVpceDnsName, &set.Parameters.S3StageVpceDnsName),
		handleParameterCreate(d, sdk.AccountParameterSamlIdentityProvider, &set.Parameters.SamlIdentityProvider),
		handleParameterCreate(d, sdk.AccountParameterSearchPath, &set.Parameters.SearchPath),
		handleParameterCreateWithMapping(d, sdk.AccountParameterServerlessTaskMaxStatementSize, &set.Parameters.ServerlessTaskMaxStatementSize, sdk.ToWarehouseSize),
		handleParameterCreateWithMapping(d, sdk.AccountParameterServerlessTaskMinStatementSize, &set.Parameters.ServerlessTaskMinStatementSize, sdk.ToWarehouseSize),
		handleParameterCreate(d, sdk.AccountParameterSimulatedDataSharingConsumer, &set.Parameters.SimulatedDataSharingConsumer),
		handleParameterCreateWithMapping(d, sdk.AccountParameterStorageSerializationPolicy, &set.Parameters.StorageSerializationPolicy, sdk.ToStorageSerializationPolicy),
		handleParameterCreate(d, sdk.AccountParameterTimestampInputFormat, &set.Parameters.TimestampInputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimestampLtzOutputFormat, &set.Parameters.TimestampLtzOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimestampNtzOutputFormat, &set.Parameters.TimestampNtzOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimestampOutputFormat, &set.Parameters.TimestampOutputFormat),
		handleParameterCreateWithMapping(d, sdk.AccountParameterTimestampTypeMapping, &set.Parameters.TimestampTypeMapping, sdk.ToTimestampTypeMapping),
		handleParameterCreate(d, sdk.AccountParameterTimestampTzOutputFormat, &set.Parameters.TimestampTzOutputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimezone, &set.Parameters.Timezone),
		handleParameterCreate(d, sdk.AccountParameterTimeInputFormat, &set.Parameters.TimeInputFormat),
		handleParameterCreate(d, sdk.AccountParameterTimeOutputFormat, &set.Parameters.TimeOutputFormat),
		handleParameterCreateWithMapping(d, sdk.AccountParameterTraceLevel, &set.Parameters.TraceLevel, sdk.ToTraceLevel),
		handleParameterCreateWithMapping(d, sdk.AccountParameterTransactionDefaultIsolationLevel, &set.Parameters.TransactionDefaultIsolationLevel, sdk.ToTransactionDefaultIsolationLevel),
		handleParameterCreateWithMapping(d, sdk.AccountParameterUnsupportedDdlAction, &set.Parameters.UnsupportedDdlAction, sdk.ToUnsupportedDDLAction),
		handleParameterCreateWithMapping(d, sdk.AccountParameterUserTaskManagedInitialWarehouseSize, &set.Parameters.UserTaskManagedInitialWarehouseSize, sdk.ToWarehouseSize),
	)
